...
curl https://cdn3.bluestacks.com/downloads/windows/nxt/5.2.100.1047/6fd7ce7bdea5724b7561a06bc604ffbd/x64/BlueStacksFullInstaller_5.2.100.1047_amd64_native.exe -o Bluestacks5Installer.exe
...
echo Click Launch When the installation is done!
echo Click Launch When the installation is done!
echo Click Launch When the installation is done!
echo Click Launch When the installation is done!
echo Click Launch When the installation is done!
...
echo Click Launch When the installation is done!
cd C:\Users\%USERNAME%\Downloads
Bluestacks5Installer.exe --defaultImageName Pie64 --imageToLaunch Pie64
...
move "C:\Users\%USERNAME%\Downloads\bsuninstaller.exe" "C:\Program Files\BlueStacks_nxt"
